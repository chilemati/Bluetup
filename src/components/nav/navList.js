...
export const navList = [
    {id: 1,text: 'Dashboard',icon1:svgs.dashbaord,icon2:'',body:'',hide:'hide', href:'/dashbaord'},
    ...
    {id: 6,text: 'Saving Challange',icon1:svgs.bitcoin,icon2: svgs.next180,body:[{text:'Overview',href:'/SC_overview',},{text:'Add new challenge',href:'/SC_addChallange',},{text:'Saving Challanges',href:'/SC_challange'},{text:'All Savers',href:'/SC_allsavers'},],hide:'',},
